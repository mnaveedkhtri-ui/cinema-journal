{
    ...
    content: `
      ...
      <p>Wim Wenders opens on a man walking out of the desert with no memory anyone can name, and the film spends nearly two and a half hours letting him become legible again, one silence at a time. The <a href="https://www.criterion.com/films/1502-paris-texas" target="_blank" rel="noopener noreferrer">Criterion Collection's own notes</a> on the film describe it as an exquisite exploration of a crumbling American landscape, and that landscape is doing as much narrative work as any line of dialogue. Harry Dean Stanton barely speaks for the first half hour. When he finally does, the wait has done something to your ear that no amount of exposition could replicate.</p>
      <h2>Stalker (1979)</h2>
      <p>We have written elsewhere about the way Tarkovsky treats a room as though it has not finished being a room, and Stalker is the fullest expression of that instinct stretched across an entire film. Three men walk into a forbidden zone toward a room that is said to grant wishes, and the walking is the film. Nothing about the pace apologizes for itself. If you have read our piece on <a href="/blog/the-hotel-room-as-a-unit-of-time">the hotel room as a unit of time</a>, you already know why we keep returning to Tarkovsky when we talk about duration.</p>
      ...
      <h2>Uncle Boonmee Who Can Recall His Past Lives (2010)</h2>
      ...
      <h2>What the Waiting Is Actually For</h2>
      <p>None of these films are slow because they have nothing to say. They are slow because what they have to say resists compression. A grief that arrives in a single cut feels like information. A grief that arrives after forty unhurried minutes feels like something closer to experience. That difference is, as far as we can tell, the entire case for this kind of cinema.</p>
      <p>If duration as a subject interests you beyond this list, our <a href="/guide">Field Guide</a> has a working chapter on it, and our <a href="/route">Routes</a> section maps a few of the physical locations behind films like these, for anyone who wants to stand where the waiting actually happened. We also returned to color and memory at length in <a href="/blog/color-scripts-and-the-long-memory">an earlier dispatch</a>, which pairs oddly well with this one if you read them back to back.</p>
      <p>We will keep adding to this list slowly, the way we do most things. If you have a film that belongs here, our <a href="/blog">other dispatches</a> are a reasonable place to see what we tend to notice, and where to reach us if you disagree with an omission.</p>
      <h2>A Few Questions We Get Asked</h2>
